...
const PioneeringAndInnovation = () => {
    return (
        <div className="PioneeringAndInnovation">
                ...
                <Box>
                    <Flex paddingTop="50px" alignItems="center" justifyContent="center" flexDirection="column">
                        <Text fontSize="16px" lineHeight="19px" fontWeight="400">
                            Welcome to Pioneering and Innovation category of Advanced Engineering performance form! HERE
                            WE NEED ADD SOME TEXT FOR DESCRIPTION AND ONBOARDING
                        </Text>
                    </Flex>
                </Box>
                <Footer />
